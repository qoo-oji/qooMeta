...
- **欄**: タイトル、著者(並び)、ジャンル、イベント、原作(2026-09-20 に「関連」から改めた。予約語は `@source`)、キーワード A・B・C、メモ、シリーズ、
  巻(表記と数)。3 アプリが管理に使う欄の和集合。
- **予約語**: `@title @author @genre @event @source @keywordA @keywordB @keywordC @ignore`。
