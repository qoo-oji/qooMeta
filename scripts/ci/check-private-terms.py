...
DEFAULT_TERMS = os.path.expanduser("~/Library/Application Support/qooMeta-dev/private-terms.txt")
DEFAULT_ALLOW = os.path.expanduser("~/Library/Application Support/qooMeta-dev/private-terms-allow.txt")
