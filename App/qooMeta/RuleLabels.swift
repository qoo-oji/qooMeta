...
enum RuleLabels {
    ...
    static let rules: [String: Item] = [
        ...
        "kanjiAlone": Item(title: "Old-style kanji numerals on their own (弐, 参)",
                           help: "壱, 弐, 参 are the old way of writing 一, 二, 三. They are read as the volume with no word before and no unit after, because — unlike an ordinary kanji numeral — they are not mistaken for a word in the title"),
        ...
        "wordNumber": Item(title: "Numbers written out as words (ふたつ, みっかめ)",
    ...
    static let lists: [String: Item] = [
        ...
        "numberWords": Item(title: "Words that stand for a number",
                            help: "ふたつ → 2, みっかめ → 3 … Some names spell the number out in kana on purpose. The word is kept as the volume you see; the number on the right is the one it sorts by. It is only read when the word stands on its own."),
        ...
        "kanjiAloneDigits": Item(title: "Kanji numerals that count on their own",
                                 help: "壱, 弐, 参, 肆, 伍 … The old way of writing 一 to 五, together with the traditional forms 壹 貳 參. “X 弐” is volume 2, while “X 二” is not read, because an ordinary kanji numeral cannot be told from a word in the title. Add 陸 and the ones after it if your books use them — mind that 陸 is an ordinary word too."),
